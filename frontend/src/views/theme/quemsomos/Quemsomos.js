        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <CCardText style={{ textAlign: 'justify'}}>
              ...
              <p>Bem-vindo à Mamoré Educacional, onde transformamos a educação matemática em experiências tangíveis e significativas. Nossa missão é promover o aprendizado através de materiais manipulativos que despertam a curiosidade, estimulam o raciocínio lógico e tornam a Matemática acessível e prazerosa para todos os estudantes.

                Desde nossa fundação, acreditamos que aprender Matemática pode e deve ser uma experiência dinâmica. Por isso, nos dedicamos à criação de ferramentas pedagógicas inovadoras que ajudam professores a transformar suas aulas e estudantes a construir conhecimentos sólidos e duradouros.</p>

            </CCardText>
            <CCardText style={{ textAlign: 'justify', textIndent: 50  }}>

              <p> Nosso time é composto por especialistas em educação, design e Matemática, comprometidos em desenvolver soluções criativas e eficazes. Cada produto da Mamoré Educacional é projetado com base em pesquisas educacionais e testado em sala de aula, garantindo qualidade e resultados reais.
